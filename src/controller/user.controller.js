...
export const registerUser = asyncHandler(async (req, res) => {
  ...
  const coverImageRes = coverImagaLocalPath
    ? await uploadOnCloudinary(coverImagaLocalPath)
    : "";
  if (!avatarRes)
...
export const changeCurrentPassword = asyncHandler(async (req, res) => {
  ...
  if (!user)
    //since this is an extra check,if removed nothing will impact to the functionality because we already checked the case in verfyJwt.
...
export const updateCoverImage = asyncHandler(async (req, res) => {
  ...
  if (publicId) deleteOnCloudinary(publicId);
